 ...
 * 
 * Stage 1: child individuals are generated by combining a set of sampled individuals.
 * Stage 2: sample mutators are applied by modifying individuals based on other sampled individuals.
 * Stage 3: mutators are applied by modifying individuals.
 * 
 * @author Sam Holder
 * @see VariationPipeline
 */
